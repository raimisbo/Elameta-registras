...
class Projektas(models.Model):
    klientas = models.ForeignKey(
        Klientas, on_delete=models.CASCADE
    )  # Ryšys su Klientas modeliu
...
class Kaina(models.Model):
    ...
    kainos_matas = models.CharField(
        max_length=10, choices=MATAS_CHOICES, default="vnt."
    )
